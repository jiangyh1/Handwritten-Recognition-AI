...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.Conv1 = nn.Sequential(
            ...
            nn.Conv2d(
                in_channels = 1,    # number of channels = 1, Input hight = 1 
                out_channels = 16,  # 16 kernel, output height = 16
                kernel_size = 5,    # kernel size = (5,5)
                stride = 1,         # 步长
                padding = 2,        # 边界填充
                ),
